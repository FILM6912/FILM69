...
class Llama():
    ...
    def chat_templet(
        ...
        if chat_format in self.chat_templet_model.keys():
            before_system=self.chat_templet_model[chat_format]["before_system"],
            after_system=self.chat_templet_model[chat_format]["after_system"],
            before_user=self.chat_templet_model[chat_format]["before_user"],
            after_user=self.chat_templet_model[chat_format]["after_user"],
            before_assistant=self.chat_templet_model[chat_format]["before_assistant"],
            after_assistant=self.chat_templet_model[chat_format]["after_assistant"]
